        ...
        <div className="bg-gradient-to-r from-orange-500 to-orange-600 rounded-xl shadow-lg p-8 text-white">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-orange-100 text-lg">Monitor and manage your resume builder platform</p>
            </div>
            <div className="hidden md:block">
              <div className="text-right">
                <p className="text-orange-100 text-sm">Total Platform Activity</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4">
          ...
          <div className="bg-white rounded-xl shadow-sm p-5 border border-gray-100 hover:shadow-md transition-all duration-200">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-2xl font-bold text-gray-900">{dashboardData.statistics?.totalResumes || 0}</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-5 border border-gray-100 hover:shadow-md transition-all duration-200">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-2xl font-bold text-gray-900">{dashboardData.statistics?.pendingResumes || 0}</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-5 border border-gray-100 hover:shadow-md transition-all duration-200">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-2xl font-bold text-gray-900">{dashboardData.statistics?.approvedResumes || 0}</p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white rounded-xl shadow-md border border-gray-100">
            <div className="px-8 py-6 border-b border-gray-100">
              <h2 className="text-2xl font-bold text-gray-900 flex items-center">
                <ChartBarIcon className="w-7 h-7 mr-3 text-orange-600" />
                Template Usage Statistics
              </h2>
              <p className="text-gray-600 mt-2">Distribution of resume templates across the platform</p>
            </div>
            <div className="p-8">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                {dashboardData.templateStats.map((template) => (
                  <div key={template._id} className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-6 text-center hover:shadow-md transition-shadow">
                    <div className="w-16 h-16 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-4">
                      <DocumentTextIcon className="w-8 h-8 text-orange-600" />
                    </div>
                    <h3 className="text-xl font-bold text-gray-900 capitalize mb-2">{template._id}</h3>
                    <p className="text-4xl font-bold text-orange-600 mb-1">{template.count}</p>
                  </div>
                ))}
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-xl shadow-md border border-gray-100">
            <div className="px-8 py-6 border-b border-gray-100">
              ...
              <p className="text-gray-600 mt-2">Latest registered users on the platform</p>
            </div>
            <div className="p-6">
                      ...
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          ...
                          {user.addressString && user.addressString !== 'undefined, undefined, undefined undefined, undefined' && (
                            <p className="text-xs text-gray-400 mt-1">{user.addressString}</p>
                          )}
                        </div>
                      </div>
                      <div className="text-right">
          ...
          <div className="bg-white rounded-xl shadow-md border border-gray-100">
            <div className="px-8 py-6 border-b border-gray-100">
              <h2 className="text-2xl font-bold text-gray-900 flex items-center">
                <DocumentTextIcon className="w-7 h-7 mr-3 text-orange-600" />
                Recent Resumes
              </h2>
              <p className="text-gray-600 mt-2">Latest resume submissions and updates</p>
            </div>
            <div className="p-6">
                ...
                <div className="space-y-4">
                  {dashboardData.recentResumes.map((resume) => (
                    <div key={resume._id} className="flex items-center justify-between p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
                      ...
                      <div className="text-right">
                        <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${getStatusColor(resume.status)}`}>
                          {resume.status}
                        </span>
